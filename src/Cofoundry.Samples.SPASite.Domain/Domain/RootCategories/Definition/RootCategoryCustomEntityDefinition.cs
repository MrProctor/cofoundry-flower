...
namespace Cofoundry.Samples.SPASite.Domain
{
    ...
    /// </summary>
    public class RootCategoryCustomEntityDefinition
        : ICustomEntityDefinition<RootCategoryDataModel>
        , ICustomizedTermCustomEntityDefinition
    {
        ...
        /// </summary>
        public const string DefinitionCode = "SPARCG";
        ...
        /// </summary>
        public string NamePlural => "Root Categories";

        /// <summary>
        /// A short description that shows up as a tooltip for the admin 
        /// panel.
        /// </summary>
        public string Description => "Root categories";
